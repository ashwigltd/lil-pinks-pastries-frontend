...
class PrivacyPage extends React.Component {
  render() {
    const siteTitle = "Lil Pink's Pastries | Privacy"

    return (
      <Layout location={this.props.location} title={siteTitle}>
        <SEO
          title="Lil Pink's Pastries Privacy Policy"
          keywords={[`lil pinks pastries`, `lilpinkspastries`, `privacy`]}
        />
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to Lil Pink.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Lil Pink's Pastries, accessible
              from{" "}
              <a
        ...
        <ul>
          <li>
            <p>By email: admin@lilpinkspastries.com</p>
          </li>
          <li>
            <p>
              By visiting this page on our website:{" "}
              <a
                href="https://lilpinkspastries.com/contact"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://lilpinkspastries.com/contact
              </a>
            </p>
          </li>
        </ul>
